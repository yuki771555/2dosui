...
- install dependencies into `/home/pi/2dosumi/.venv`
...
```powershell
.\scripts\deploy_pi.ps1 -HostName raspberrypi.local -User pi -RemoteDir /home/pi/2dosumi
```
